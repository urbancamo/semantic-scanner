...
import uk.m0nom.apps.scanner.file.ModelFilenameFilter;
import uk.m0nom.file.detectors.CustomMimeType;
import uk.m0nom.file.detectors.openvms.VmsCustomMimeTypeLibrary;
import uk.m0nom.file.detectors.openvms.VmsFeature;
import uk.m0nom.jena.vms.LexicalRdf;

public class QueryDataBinding {
	public final String DONT_CARE = "Don't care";

	private final VmsCustomMimeTypeLibrary mimeTypes;
